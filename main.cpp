...
int main(int argc, char** argv)
{
    if (argc < 8 || argc > 10)
    {
        cout << "tree usage: " << argv[0] << " <filename.newick> <filename.newick> <align> <0=matching 1=crossing 2=strict> <j=jaccard s=symdif> <k> <0=greedy 1=fractional 2=bnb 3=covering-packing 4=bng 5=integral>" << endl;
        ...
        cout << "tree usage (2): " << argv[0] << " <tree> <map> <tree> <map> <align> <0=matching 1=crossing 2=strict> <j=jaccard s=symdif> <k> <0=greedy 1=fractional 2=bnb 3=covering-packing 4=bng 5=integral>" << endl;
        return EXIT_FAILURE;
    }
