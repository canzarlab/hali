...
CXX = g++
CFLAGS = -O2 -std=c++11 -pthread -m64 #-I$(MKLROOT)/include -DEIGEN_USE_MKL_ALL
INCL = -I.
...
solver: $(GENO_OBJS) Graph.o Greedy.o Solver.o LP.o AntichainConstraint.o Constraint.o IndependentSetConstraint.o CrossingConstraint.o newick.o BnB.o Similarity.o LPInt.o BnG.o
